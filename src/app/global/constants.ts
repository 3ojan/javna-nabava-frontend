...
//padding
export const sitePaddingHorizontalLargeScreen = "40px"//7%
export const sitePaddingHorizontalMidScreen = "40px"//4%
export const sitePaddingHorizontalMobileScreen = "14px"
//font
